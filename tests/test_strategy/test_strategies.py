...
def test_rsi_strategy():
    ...
    historical_quotes = [{'time_key': '2022-08-19 10:30:00', 'code': 'HK.00002', 'open': 64.6, 'close': 61.6, 'high': 70.6, 'low': 60.1, 'volume': 30600, indicator: 15.0}]
...
def test_ma_strategy():
    ...
    historical_quotes = [{'time_key': '2022-08-19 10:30:00', 'code': 'HK.00002', 'open': 64.6, 'close': 61.6, 'high': 70.6, 'low': 60.1, 'volume': 30600, short_period_indicator: 60.0, long_period_indicator: 50.0}]
    stockframe = futubot.create_stockframe(data=historical_quotes)

    indicator_client = Indicators(stockframe=stockframe)
    existing_orders = {'HK.00002': False}

    strategy_client = MAStrategy(
        stockframe=stockframe,
        portfolio=portfolio,
        indicator_client=indicator_client,
        existing_orders=existing_orders,
...
def test_macd_crossover_strategy():
    ...
    historical_quotes = [{'time_key': '2022-08-19 10:30:00', 'code': 'HK.00002', 'open': 64.6, 'close': 61.6, 'high': 70.6, 'low': 60.1, 'volume': 30600, 'macd': 34.0, 'signal': 23.0}]
    stockframe = futubot.create_stockframe(data=historical_quotes)

    indicator_client = Indicators(stockframe=stockframe)
    existing_orders = {'HK.00002': False}

    strategy_client = MACDCrossOverStrategy(
        stockframe=stockframe,
        portfolio=portfolio,
        indicator_client=indicator_client,
        existing_orders=existing_orders
...
def test_bollinger_bands_strategy():
    ...
    historical_quotes = [{'time_key': '2022-08-19 10:30:00', 'code': 'HK.00002', 'open': 64.6, 'close': 61.6, 'high': 70.6, 'low': 60.1, 'volume': 30600, 'sma': 63.5, 'upper_band': 65.0, 'lower_band': 62.0}]
    stockframe = futubot.create_stockframe(data=historical_quotes)

    indicator_client = Indicators(stockframe=stockframe)
    existing_orders = {'HK.00002': False}

    strategy_client = BollingerBandsStrategy(
        stockframe=stockframe,
        portfolio=portfolio,
        indicator_client=indicator_client,
        existing_orders=existing_orders
